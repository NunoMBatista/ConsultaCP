The Segment Tree is a useful data structure that allows us to answer range queries over an array.

- Change the `op` to the appropriate query operation and `DEFAULTVALUE` to the appropriate default value (e.g: 0 for sum/XOR, INF for min)
